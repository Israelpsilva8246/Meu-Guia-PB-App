...
fun FindAttractionByTypeView(
    ...
    Box(
        ...
        Scaffold(
            ...
            content = {
                FindAttractionByType(modifier = Modifier.padding(it), navController, viewModel)
            }
        )
    }
}
...
fun FindAttractionByType(
    ...
    val type: List<String> = runBlocking {
        viewModel.fetchAttractionTypeNames()
    }
    var isExpanded by remember { mutableStateOf(false) }
    var selectedText by remember { mutableStateOf(type[0]) }
    ...
    Column(modifier = modifier.padding(start = 8.dp, end = 8.dp)) {
        ...
        Button(onClick = {
            scope.launch(Dispatchers.IO) {
                isFetching = true
                showDetails = true
                viewModel.fetchAttractionByType(selectedText)
            }
                            ...
                            Row(
                                ...
                                Image(
                                    painter = rememberAsyncImagePainter(
                                        ...
                                        ).data(data = attractive.image_link).apply(block = fun ImageRequest.Builder.() {
                                            scale(Scale.FILL)
