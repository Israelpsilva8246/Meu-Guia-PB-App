...
fun FindAttractionByNameView(
    ...
    Box(
        ...
        Scaffold(
            ...
            content = {
                FindAttraction(modifier = Modifier.padding(it), navController, viewModel)
            }
        )
    }
}
...
fun FindAttraction(
    ...
    val name: List<String> = runBlocking {
        viewModel.fetchAttractionNames()
    }
    ...
    Column(modifier = modifier.padding(start = 8.dp, end = 8.dp)) {
        Column(
            ...
            ExposedDropdownMenuBox(
                ...
                ExposedDropdownMenu(
                    ...
                    name.forEachIndexed { index, text ->
                        DropdownMenuItem(
                            text = { Text(text = text) },
                            onClick = {
                                selectedText = name[index]
                                isExpanded = false
                            },
        ...
        Button(onClick = {
            scope.launch(Dispatchers.IO) {
                isFetching = true
                showDetails = true
                viewModel.fetchAttractionByName(selectedText)
            }
