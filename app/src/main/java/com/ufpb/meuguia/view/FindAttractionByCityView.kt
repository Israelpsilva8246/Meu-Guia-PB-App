...
fun FindAttractionByCityView(
    ...
    Box(
        ...
        Scaffold(
            ...
            content = {
                FindAttractionByCity(modifier = Modifier.padding(it), navController, viewModel)
            }
        )
    }
}
...
fun FindAttractionByCity(
    ...
    val city: List<String> = runBlocking {
        viewModel.fetchAttractionCity()
    }
    var isExpanded by remember { mutableStateOf(false) }
    var selectedText by remember { mutableStateOf(city[0]) }
    ...
    Column(modifier = modifier.padding(start = 8.dp, end = 8.dp)) {
        Column(
            ...
            ExposedDropdownMenuBox(
                ...
                ExposedDropdownMenu(
                    ...
                    city.forEachIndexed { index, text ->
                        DropdownMenuItem(
                            text = { Text(text = text) },
                            onClick = {
                                selectedText = city[index]
                                isExpanded = false
                            },
        ...
        Button(onClick = {
            scope.launch(Dispatchers.IO) {
                isFetching = true
                showDetails = true
                viewModel.fetchAttractionByCity(selectedText)
            }
                            ...
                            Row(
                                ...
                                Image(
                                    painter = rememberAsyncImagePainter(
                                        ...
                                        ).data(data = attractive.image_link)
